...
- `g-medic` L1 triage: when subsystem count > 20 and no PRODUCT_SYSTEMS.md exists
- `g-medic` L1 triage: when >25% of subsystem specs lack `parent_system:`
- Session start: when subsystem count > 25 and PRODUCT_SYSTEMS.md is absent
