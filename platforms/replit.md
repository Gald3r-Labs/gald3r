...
- gald3r hooks (`.py`, C-NO-PS1) do NOT auto-fire on Replit — no lifecycle hook system exists here;
  treat hook automation as unavailable; express behaviors in `replit.md` or git `core.hooksPath` bash.
...
---
*Reference page — canonical source: `g-skl-platform-replit/PLATFORM_SPEC.md` in the engine repo, generated by `scripts/generate_platform_support_docs.py`. Pages marked *curated* are hand-assessed and not yet live-verified.*
