---
description: 'Update a feature staging doc''s YAML fields and FEATURES.md index row via g-skl-features UPDATE FEATURE'
...
Updates feature file YAML fields and FEATURES.md index row.
