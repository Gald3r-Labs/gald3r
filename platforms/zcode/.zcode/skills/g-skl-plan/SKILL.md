...
`gald3r prompt get playbook.plan` (MCP `gald3r_prompt_get id=playbook.plan` -- served over stdio by `gald3r mcp serve`; hosts add {"command": "gald3r", "args": ["mcp", "serve"]} to their MCP config)
