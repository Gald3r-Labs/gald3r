---
description: 'Activate the QA system for bug tracking, bug-task linking, and retroactive fix documentation'
argument-hint: '[bug description or quality concern]'
