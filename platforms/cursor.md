...
`gald3r sync` / `gald3r platform install` (C-NO-PS1/T628 —
`custom_scripts/platform_parity_sync.ps1` never existed on disk). As of mid-2026 Cursor natively supports **all six** <!-- ps1-gate-allow -->
...
---
*Reference page — canonical source: `g-skl-platform-cursor/PLATFORM_SPEC.md` in the engine repo, generated by `scripts/generate_platform_support_docs.py`. Pages marked *curated* are hand-assessed and not yet live-verified.*
