...
Opens `.gald3r/linking/INBOX.md`, triages items by type, and routes each to the appropriate response action. CONFLICTs are surfaced first and block all other work until resolved. Uses `g-skl-wpac-read`.
...
- **SYNC**: Update `linking/_peers/{sender_name}.md` with new contract data; mark `[DONE]`
