...
Distinct from L1/L2/L3 code tests: this runs `scripts/gald3r_system_test.ps1`, which
...
pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/gald3r_system_test.ps1
...
pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/gald3r_system_test.ps1 -Json

# Subset of systems
pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/gald3r_system_test.ps1 -Systems "task,bug,hooks,git_hooks,schema"
```
