...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .cursor/skills/g-skl-subsystems/scripts/gald3r_subsystem_hierarchy_sync.ps1 -ProjectRoot .
```
...
**Regenerate architecture diagrams** (Mermaid, separate tree vs dependency views; includes nested spec paths): `.cursor/skills/g-skl-subsystems/scripts/gald3r_subsystem_diagrams_generate.ps1` (see `SUBSYSTEMS.md` → Generated architecture diagrams).
