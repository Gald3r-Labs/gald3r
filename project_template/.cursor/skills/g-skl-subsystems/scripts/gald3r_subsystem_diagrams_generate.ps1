...
$banner = @"
<!-- AUTO-GENERATED - do not hand-edit. Source: .cursor/skills/g-skl-subsystems/scripts/gald3r_subsystem_diagrams_generate.ps1 -->
<!-- Generated (UTC): $iso -->
<!-- Regenerate: pwsh -NoProfile -File .cursor/skills/g-skl-subsystems/scripts/gald3r_subsystem_diagrams_generate.ps1 -ProjectRoot (repo root) -->
