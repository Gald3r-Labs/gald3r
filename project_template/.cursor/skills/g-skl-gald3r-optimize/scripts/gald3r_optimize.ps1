...
.EXAMPLE
  pwsh -File gald3r_optimize.ps1 -Path .cursor/skills/g-skl-tasks/SKILL.md
  pwsh -File gald3r_optimize.ps1 -Mode AUDIT -Path .cursor/skills -Json
  pwsh -File gald3r_optimize.ps1 -Mode PREVIEW -Path .cursor/rules/g-rl-33-enforcement_catchall.md
  pwsh -File gald3r_optimize.ps1 -Mode APPLY -Path .cursor/skills/g-skl-foo/SKILL.md -Confirm
#>
[CmdletBinding()]
param(
