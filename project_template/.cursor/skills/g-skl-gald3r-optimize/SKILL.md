...
gald3r system files (`.cursor/skills/*/SKILL.md`, `.cursor/rules/g-rl-*.md`,
`.cursor/agents/*.md`, `.cursor/commands/*.md`) accumulate bloat over time: rationalization
...
```
pwsh -File .cursor/skills/g-skl-gald3r-optimize/scripts/gald3r_optimize.ps1 -Mode AUDIT -Path <file-or-dir>
...
`.cursor/skills/g-skl-gald3r-optimize/scripts/gald3r_optimize.ps1`. Source task: T1054.
