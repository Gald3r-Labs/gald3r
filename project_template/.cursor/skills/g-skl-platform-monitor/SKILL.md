...
Delegates the read/report mechanics to `scripts/check_platform_status.ps1 -Platform <name>`.
...
- Script: `scripts/check_platform_status.ps1` (CHECK / status-read entry point).
