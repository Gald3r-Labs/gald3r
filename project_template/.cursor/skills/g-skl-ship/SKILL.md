...
4. Run `.cursor/skills/g-skl-release/scripts/gald3r_semver.ps1 -BumpType <type> -Theme "<theme>" -Apply`
...
- `.cursor/skills/g-skl-release/scripts/gald3r_semver.ps1` — PowerShell engine (gald3r projects)
- `.cursor/skills/g-skl-release/scripts/gald3r_release.ps1` — maintainer tool for gald3r's own 3-repo release
