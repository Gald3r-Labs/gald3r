...
> **Distinction from Features**: A Feature is something we're building. A PRD is something we are accountable for.
> Features (`FEATURES.md` / `features/`) and PRDs (`PRDS.md` / `prds/`) are fully parallel — neither requires the other.
