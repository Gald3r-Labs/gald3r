...
**If `gald3r ship` is not found** (project doesn't have it yet):
...
- `gald3r ship` -- Python release/semver engine (gald3r projects)
- `gald3r_release.py` — maintainer tool for gald3r's own release; moved to the maintainer tree, not shipped (T1652 D9)
