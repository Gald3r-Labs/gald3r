...
□ Current project has .gald3r/workspace/topology.md (WPAC is initialized)
...
| No WPAC in current project | Create `.gald3r/workspace/` in current project; initialize topology; then proceed |
