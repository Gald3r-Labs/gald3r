...
.EXAMPLE
  pwsh -File gald3r_optimize.ps1 -Path .claude/skills/g-skl-tasks/SKILL.md
  pwsh -File gald3r_optimize.ps1 -Mode AUDIT -Path .claude/skills -Json
  pwsh -File gald3r_optimize.ps1 -Mode PREVIEW -Path .claude/rules/g-rl-33-enforcement_catchall.md
  pwsh -File gald3r_optimize.ps1 -Mode APPLY -Path .claude/skills/g-skl-foo/SKILL.md -Confirm
#>
[CmdletBinding()]
param(
