...
gald3r system files (`.claude/skills/*/SKILL.md`, `.claude/rules/g-rl-*.md`,
`.claude/agents/*.md`, `.claude/commands/*.md`) accumulate bloat over time: rationalization
...
```
pwsh -File .claude/skills/g-skl-gald3r-optimize/scripts/gald3r_optimize.ps1 -Mode AUDIT -Path <file-or-dir>
...
`.claude/skills/g-skl-gald3r-optimize/scripts/gald3r_optimize.ps1`. Source task: T1054.
