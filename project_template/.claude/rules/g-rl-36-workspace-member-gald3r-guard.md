...
- **Canonical rule file (edit here)**: `.claude/rules/g-rl-36-workspace-member-gald3r-guard.md`
...
| "I'll edit gald3r_dev/.gald3r_sys/ directly" | Edit canonical under `gald3r_templates/project_template/.gald3r_sys/` then run `-SyncGaldSys -Sync`. |
