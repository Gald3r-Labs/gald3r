...
- **Propagate**: `G:/gald3r_ecosystem/gald3r_templates/custom_scripts/platform_parity_sync.ps1 -SyncGaldSys -Sync` → `gald3r_dev/.gald3r_sys/`, `gald3r_template_{slim,full,adv}/project_template/.gald3r_sys/`, `gald3r/project_template/.gald3r_sys/`
