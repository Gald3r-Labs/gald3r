...
- **Edit canonical sources only** — `claude_cursor_unified_template/.gald3r_sys/`. Never hand-edit the synced
...
- **Common vs. platform-specific** — follow the decision tree in `g-skl-platform-cursor/SKILL.md`.
  Universal gald3r logic goes in `.claude/skills|agents|hooks/`; platform-only config goes in
