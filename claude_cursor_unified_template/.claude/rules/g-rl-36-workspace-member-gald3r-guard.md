...
- **Canonical rule file (edit here)**: `G:/gald3r_ecosystem/gald3r_templates/claude_cursor_unified_template/.claude/rules/g-rl-36-workspace-member-gald3r-guard.md`
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .claude/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1 `
