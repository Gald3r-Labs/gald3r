...
Audit the gald3r system corpus (`.claude/skills/*/SKILL.md`, `rules/g-rl-*.md`, `agents/*.md`,
...
@g-gald3r-optimize .claude/skills              # AUDIT a directory
...
Helper: `.claude/skills/g-skl-gald3r-optimize/scripts/gald3r_optimize.ps1`
