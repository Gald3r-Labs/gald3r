...
```powershell
pwsh -File .cursor/skills/g-skl-toon-output/scripts/toon_test.ps1   # exit 0 = all pass
```
...
Helper: `.cursor/skills/g-skl-toon-output/scripts/toon_output.ps1`
```powershell
pwsh -File .cursor/skills/g-skl-toon-output/scripts/toon_output.ps1 `
