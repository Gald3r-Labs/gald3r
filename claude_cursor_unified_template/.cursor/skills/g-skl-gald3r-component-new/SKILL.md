...
**File path**: `.cursor/skills/g-skl-<name>/SKILL.md`
...
**File path**: `.cursor/commands/g-<verb>-<noun>.md`
...
**File path**: `.cursor/rules/g-rl-<NN>-<slug>.md`
...
**Conventions**:
- Rule number must be unique. Run `ls .cursor/rules/*.md | sort` to find the highest.
...
**File path**: `.cursor/agents/g-agnt-<name>.md`
...
**File path**: `.cursor/hooks/g-hk-<name>.ps1`
