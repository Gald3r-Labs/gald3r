# .cursor/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1
#
...
#
# Usage:
#   ./.cursor/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1 -TargetPath <path>
#   ./.cursor/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1 -TargetPath <path> -DotGald3rPath ".identity"
#   ./.cursor/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1 -TargetPath <path> -DotGald3rPath "TASKS.md"
#   ./.cursor/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1 -TargetPath <path> -AllowMarkerInit
#   ./.cursor/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1 -TargetPath <path> -WarnOnly -Json
