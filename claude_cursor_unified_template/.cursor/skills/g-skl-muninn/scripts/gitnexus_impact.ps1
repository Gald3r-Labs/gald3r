<#
.SYNOPSIS
    [DEPRECATED — T1158] Use `.cursor/skills/g-skl-muninn/scripts/graph_impact.ps1` instead.
...
.DESCRIPTION
    ...
    plugin T1157). Use `.cursor/skills/g-skl-muninn/scripts/graph_impact.ps1` for all new work — it
...
# DEPRECATION NOTICE — T1158. Forward to .cursor/skills/g-skl-muninn/scripts/graph_impact.ps1 when
...
if (Test-Path $replacement) {
    Write-Warning "[DEPRECATED] .cursor/skills/g-skl-muninn/scripts/gitnexus_impact.ps1 is deprecated (T1158). Forwarding to .cursor/skills/g-skl-muninn/scripts/graph_impact.ps1."
