...
- **Canonical rule file (edit here)**: `G:/gald3r_ecosystem/gald3r_templates/claude_cursor_unified_template/.cursor/rules/g-rl-36-workspace-member-gald3r-guard.md`
- **Propagate**: `G:/gald3r_ecosystem/gald3r_templates/custom_scripts/platform_parity_sync.ps1 -SyncGaldSys -Sync` → `gald3r_dev/.gald3r_sys/`, `gald3r_template_{slim,full,adv}/claude_cursor_unified_template/.gald3r_sys/`, `gald3r/claude_cursor_unified_template/.gald3r_sys/`
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .cursor/skills/g-skl-workspace/scripts/check_member_repo_gald3r_guard.ps1 `
...
| "I'll edit gald3r_dev/.gald3r_sys/ directly" | Edit canonical under `gald3r_templates/claude_cursor_unified_template/.gald3r_sys/` then run `-SyncGaldSys -Sync`. |
