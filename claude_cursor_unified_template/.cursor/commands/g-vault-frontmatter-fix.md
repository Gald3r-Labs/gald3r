...
Runs `.cursor/skills/g-skl-vault/scripts/frontmatter_fix.ps1`:
...
```powershell
pwsh -NoProfile -File .cursor/skills/g-skl-vault/scripts/frontmatter_fix.ps1            # dry-run
pwsh -NoProfile -File .cursor/skills/g-skl-vault/scripts/frontmatter_fix.ps1 -Apply
pwsh -NoProfile -File .cursor/skills/g-skl-vault/scripts/frontmatter_fix.ps1 -File "<path>" -Apply
```
