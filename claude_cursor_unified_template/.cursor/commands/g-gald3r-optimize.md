...
Audit the gald3r system corpus (`.cursor/skills/*/SKILL.md`, `rules/g-rl-*.md`, `agents/*.md`,
...
@g-gald3r-optimize .cursor/skills              # AUDIT a directory
...
Helper: `.cursor/skills/g-skl-gald3r-optimize/scripts/gald3r_optimize.ps1`
