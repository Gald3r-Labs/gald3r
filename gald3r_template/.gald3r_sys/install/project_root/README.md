...
**Canonical edit location:** `gald3r_templates/gald3r_template/.gald3r_sys/install/project_root/`
...
`.gitignore`, `scripts/`, `temp_docs/`, and `temp_scripts/` remain at the `gald3r_template/` payload root (not in this folder).
