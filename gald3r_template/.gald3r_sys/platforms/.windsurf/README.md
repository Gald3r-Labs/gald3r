# Windsurf IDE — gald3r Deploy Scaffold

**Config folder**: `.windsurf/`
...
Authoritative install + customization guide: **`g-skl-platform-windsurf`** (.gald3r_sys/skills/g-skl-platform-windsurf/SKILL.md).

> **Status (T1277 — complete):** the full per-platform deploy payload is authored.
> See **`windsurf_instructions.md`** in this directory for the deploy guide (folder layout, config files,
