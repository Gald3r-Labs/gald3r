# g-skl-auto-triage — Reactive Auto-Triage (Medic L0)

**Skill ID:** `g-skl-auto-triage`
**Phase:** 1 (cautious — low courage, expand in Phase 2)
**Triggered by:** `g-rl-35` bug discovery gate (non-code kinds), session-start drift detection (g-rl-25 steps 2 and 4)
**Task:** T1385
