...
Authoritative reference for Gemini CLI (Google DeepMind) customization in gald3r projects. Covers .agent/ folder layout, GEMINI.md, rules, skills, commands, and install verification.

## When to use

- Invoke via `@g-skl-platform-gemini` (or when the agent determines this skill is relevant)
