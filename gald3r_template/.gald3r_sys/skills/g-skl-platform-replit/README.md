...
Authoritative reference for Replit Agent (cloud IDE) customization in gald3r projects. Covers .replit config, Agent instructions, and gald3r integration patterns for web-based development.

## When to use

- Invoke via `@g-skl-platform-replit` (or when the agent determines this skill is relevant)
