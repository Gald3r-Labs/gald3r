...
Authoritative reference for Qwen Code (Alibaba CLI coding agent) customization in gald3r projects. Covers .qwen/ config, instructions, and gald3r install verification.

## When to use

- Invoke via `@g-skl-platform-qwen` (or when the agent determines this skill is relevant)
