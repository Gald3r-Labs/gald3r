...
|---|---|---|---|---|---|---|---|
| [aider](platforms/aider.md) | ⚠ | ✅ | ❌ | ❌ | ⚠ | ❌ | CLI (L1) |
| [amp](platforms/amp.md) | ❓ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [antigravity](platforms/antigravity.md) | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | MCP (L2) |
| [astrbot](platforms/astrbot.md) | ❓ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [augment](platforms/augment.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | MCP (L2) |
| [claude](platforms/claude.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | MCP (L2) |
| [cline](platforms/cline.md) | ✅ | ✅ | ❌ | ✅ | ⚠ | ✅ | MCP (L2) |
| [codebuddy](platforms/codebuddy.md) | ✅ | ✅ | ❓ | ✅ | ❌ | ✅ | MCP (L2) |
| [codex](platforms/codex.md) | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | MCP (L2) |
| [continue](platforms/continue.md) | ✅ | ✅ | ✅ | ⚠ | ❌ | ✅ | MCP (L2) |
| [copilot](platforms/copilot.md) | ✅ | ✅ | ✅ | ✅ | ⚠ | ✅ | MCP (L2) |
| [cursor](platforms/cursor.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | MCP (L2) |
| [deepcode](platforms/deepcode.md) | ⚠ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [goose](platforms/goose.md) | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | MCP (L2) |
| [hermes](platforms/hermes.md) | ⚠ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [junie](platforms/junie.md) | ✅ | ✅ | ✅ | ✅ | ⚠ | ✅ | MCP (L2) |
| [kilo_code](platforms/kilo_code.md) | ✅ | ✅ | ❓ | ✅ | ❌ | ✅ | MCP (L2) |
| [kimi](platforms/kimi.md) | ⚠ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [kiro](platforms/kiro.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | MCP (L2) |
| [kiro_cli](platforms/kiro_cli.md) | ⚠ | ✅ | ⚠ | ✅ | ⚠ | ✅ | MCP (L2) |
| [mimo-code](platforms/mimo-code.md) | ✅ | ✅ | ✅ | ⚠ | ⚠ | ✅ | MCP (L2) |
| [mistral](platforms/mistral.md) | ⚠ | ⚠ | ✅ | ✅ | ⚠ | ✅ | MCP (L2) |
| [openclaw](platforms/openclaw.md) | ⚠ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [opencode](platforms/opencode.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | MCP (L2) |
| [openhands](platforms/openhands.md) | ⚠ | ✅ | ✅ | ✅ | ✅ | ✅ | MCP (L2) |
| [pi](platforms/pi.md) | ✅ | ✅ | ❌ | ✅ | ✅ | ❌ | CLI (L1) |
| [qoder](platforms/qoder.md) | ✅ | ✅ | ❓ | ✅ | ❌ | ✅ | MCP (L2) |
| [qwen](platforms/qwen.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | MCP (L2) |
| [replit](platforms/replit.md) | ❌ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [roo](platforms/roo.md) | ✅ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [trae](platforms/trae.md) | ⚠ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [void](platforms/void.md) | ❌ | ✅ | ❌ | ❌ | ❌ | ✅ | MCP (L2) |
| [warp](platforms/warp.md) | ⚠ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [windsurf](platforms/windsurf.md) | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | MCP (L2) |
| [zcode](platforms/zcode.md) | ✅ | ✅ | ⚠ | ✅ | ❌ | ✅ | MCP (L2) |
| [zed](platforms/zed.md) | ❌ | ✅ | ❌ | ✅ | ❌ | ✅ | MCP (L2) |
| [subq](platforms/subq.md) | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | files-only (L0) |
