...
<h1 align="center">Gald3r - AI Dev Framework for 23 AI Coding Tools</h1>

<p align="center">
  File-based memory, task management, and agent orchestration that works across
  Cursor, Claude Code, Copilot, Windsurf, Cline, Roo, Codex, Aider, OpenHands, Gemini,
  OpenCode, and 12 more.
</p>
...
## Platform Support (23 AI Coding Tools) {#platform-support-23-ai-coding-tools}
...
| ![Roo Code](https://img.shields.io/badge/Roo_Code-Tier_1-green) | [roo/](./roo/) | Copy oo/ contents to project root |
...
| Tool | Folder | Install |
|---|---|---|
| ![Aider](https://img.shields.io/badge/Aider-Tier_2-yellow) | [aider/](./aider/) | Copy ider/ contents to project root |
| ![Augment](https://img.shields.io/badge/Augment-Tier_2-yellow) | [augment/](./augment/) | Copy ugment/ contents to project root |
...
| ![Replit](https://img.shields.io/badge/Replit-Tier_2-yellow) | [replit/](./replit/) | Copy eplit/ contents to project root |
...
| ![Antigravity](https://img.shields.io/badge/Antigravity-Tier_3-orange) | [antigravity/](./antigravity/) | Copy ntigravity/ contents to project root |
...
**New project?** â†’ [instructions_new_project.md](./instructions_new_project.md)

**Adding to an existing project?** â†’ [instructions_existing_project.md](./instructions_existing_project.md)
